...
В процессе выполнения аналитической работы мы ознакомились с сервисами Microsoft Azure и изучили их документацию,
которая показалась нам более понятной и удобной по сравнению с AWS. Мы классифицировали данные слепка биллинга от
провайдера в следствии чего работа была выполнена.